  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Date-specific styles - fix spacing by adding right padding for calendar icon
        "pr-10",
        // Position calendar icon properly
        ...
        "[&::-webkit-calendar-picker-indicator]:bg-transparent [&::-webkit-calendar-picker-indicator]:border-0 [&::-webkit-calendar-picker-indicator]:w-4 [&::-webkit-calendar-picker-indicator]:h-4",
