    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="h-8 w-8 p-0 hover:bg-gradient-to-r hover:from-primary/10 hover:to-secondary/10 rounded-full animate-spring hover-scale-sm">
