-- Migration: fix_get_edition_details_fields
-- Updates get_edition_details to use p_edition_id and p_organization_id as parameters and returns book_title and authors
